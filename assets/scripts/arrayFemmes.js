let femmes = [
  {
    ...
    hint1:
      "La grève de Greta a attiré l'attention des médias du monde entier, et a incité des dizaines de milliers d'écoliers autour du monde à faire de même",
    hint2:
      "Selon Greta, la multiplication des grèves de l'école pour le climat est une bonne chose, 'Cela prouve que nous ne sommes jamais trop petits pour faire la différence'",
    bibli:
  ...
  },
  {
    ...
    hint2:
      "le texte étant traduit dans plus de 70 langues et serait le livre le plus traduit et le plus lu dans le monde après la Bible",
    bibli:
      "Anne Frank, née le 12 juin 1929 à Francfort, est une jeune fille juive qui est connue pour avoir survécu en Allemagne nazie durant presque toute la Seconde Guerre mondiale, mais est morte (ainsi que presque toute sa famille sauf Otto, son père) peu avant la fin de la guerre du typhus à Bergen-Belsen. Elle est célèbre pour avoir écrit Le Journal d'Anne Frank, un journal intime qui lui est offert pour ses treize ans. Elle raconte comment sa famille et quatre amis ont vécu de 1942 à 1944, cachés dans une annexe de bureaux, grâce aux employés de l'entreprise de son père. Le journal a été publié par son père pour lui rendre hommage, et est devenu le livre le plus traduit au monde après la Bible. Ce document est précieux du point de vue historique, mais aussi très apprécié pour le talent littéraire d'Anne Frank.",
  },
  {
    id: "3",
    img: "rosaParks.png",
    ...
    hint1:
      "Elle a refusé de laisser sa place à quelqu'un à la peau blanche dans le bus. En effet, à cette époque, les personnes de couleur noire devaient laisser leur place aux gens à la peau blanche dans le bus.",
    hint2:
      " La veille de son jugement, un jeune pasteur noir, Martin Luther King, a lancé un boycott contre la compagnie de bus.",
    bibli:
      "Rosa Parks est née le 4 février 1913 en Alabama et morte le 24 octobre 2005. En 1955, Rosa prend le bus et s'assoit sur une place réservée aux blancs. Un blanc monte et le chauffeur demande à Rosa de laisser sa place. Selon la loi les noirs ne peuvent voyager que dans le fond du bus dans la zone qui leur est réservée. Rosa refuse. Le chauffeur appelle la police et elle est arrêtée.  Pendant 380 jours, des milliers de personnes refusent de prendre le bus. En novembre 1956, la cour suprême vote la fin de la ségrégation raciale dans les bus municipaux. Elle représente le combat pour la défense des droits civiques des personnes de couleur noire. En 2013, Barack Obama a inauguré sa statue dans la galerie du Capitole. On parle de Rosa Parks pour figurer sur les prochains billets de 20 $.",
  },
  {
    id: "4",
    img: "hatchepsut.png",
...

  {
    ...
    bibli:
      "Njinga Mbandi (1581-1663), reine du Ndongo et du Matamba au 17e siècle. En 1617, son frère Ngola Mbandi devient roi du Ndongo. Il n'a cependant ni le charisme de son père, ni l'intelligence de sa sœur. Acculé par les Portugais, il envoie Njinga comme ambassadrice afin de négocier la paix avec le vice-roi du Portugal. Njinga s'illustre alors comme une négociatrice et une diplomate hors du commun. En 1624, Ngola Mbandi décède. Njinga prend le pouvoir et devient reine. Elle s'impose comme une souveraine exceptionnelle. Sa tactique guerrière et d'espionnage, sa capacité à tisser de multiples alliances stratégiques, enfin sa connaissance des enjeux commerciaux et religieux, lui permettront d'opposer une résistance tenace aux projets coloniaux portugais et ce jusqu'à sa mort, en 1663.",
  },
  ...
  },
  {
    ...
    phrase: "Une pédagogue italienne célèbre pour sa méthode",
    dateNaissance: "08/31/1870 ",
    hint1:
      "Etant une femme, à son époque, elle a rencontré beaucoup de difficultés pour faire ses études de médecine",
    hint2: "Elle a dû fuir plus d'un régime fasciste au cours de sa vie",

    bibli:
      "Maria Montessori voit le jour le 31 août 1870 dans les Marches en Italie. Quelques années plus tard, elle déménage avec ses parents dans la capitale du pays. Ses parents ont toujours été soucieux de son éducation et la destinaient à une carrière d'enseignante. Or, la jeune Maria voulait devenir docteure. Un défi majeur d'autant plus que, la faculté de médecine italienne n'avait jusque-là accepté aucune étudiante.   Elle devient docteure, scientifique et éducatrice. Elle est toujours acclamée pour sa méthode éducative basée sur une approche ludique et stimulante permettant à l'enfant d'apprendre naturellement et sans contraintes. Elle a promu une approche basée sur l'auto-discipline et la motivation pour le développement des enfants et des jeunes adolescents. Elle s'éteint le 6 mai 1952.",
  },

  {
    ...
    hint1: "Elle a découvert les éléments radium et polonium",
    hint2: "Elle a gagné non pas un mais 2 prix Nobel",

    bibli:
      "Maria Sklodowska-Curie est née à Varsovie le 7 novembre 1867. Brillante élève, elle part en 1891 pour Paris, où elle étudie les sciences physique et mathématique. En 1894, elle rencontre Pierre Curie et l'épouse. Elle analyse avec son mari les rayonnements d'un minerai riche en uranium, la pechblende. Ils découvrent deux nouveaux éléments, le Polonium et le Radium. Elle reçoit avec son mari et Henri Becquerel le Prix Nobel de Physique. Elle est la première femme à recevoir un prix Nobel. Suite du décès de Pierre, elle le remplace à son poste de professeur à la Sorbonne et devient la première femme à enseigner dans cette université. Le 10 décembre 1911, elle reçoit le Prix Nobel de Chimie. Elle est la première personne à obtenir deux prix Nobel. Elle décède le 4 jullet 1934.",
  },
];
